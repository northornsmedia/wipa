  ...
  return (
    <div className="min-h-screen bg-[#060608] text-white flex flex-col justify-between items-center p-6 relative overflow-hidden font-sans selection:bg-pink-500 selection:text-white">
      ...
      <main className="w-full max-w-sm flex-1 flex flex-col justify-center items-center z-10 py-6">
        {/* Page Title */}
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-white mb-2 text-center font-sans">
        ...
        <form onSubmit={handleSignup} className="w-full space-y-5">
          ...
          <div className="space-y-1.5 relative">
            ...
            <div className="flex justify-center items-center gap-3 pt-2 text-[10px] text-gray-400">
              <span className={passwordStrength.length ? "text-emerald-400 font-semibold" : ""}>• 8+ chars</span>
              <span className={passwordStrength.number ? "text-emerald-400 font-semibold" : ""}>• 1 number</span>
              <span className={passwordStrength.special ? "text-emerald-400 font-semibold" : ""}>• 1 symbol</span>
            </div>
          </div>

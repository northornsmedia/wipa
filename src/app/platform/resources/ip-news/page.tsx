...
export default function IPNewsHubPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070b14] text-slate-900 dark:text-slate-100 font-sans pb-24 overflow-x-hidden selection:bg-orange-500/20">
      ...
      {/* Top High-Tech Ticker Bar */}
      <div className="w-full bg-slate-950 text-white overflow-hidden py-3.5 border-b border-orange-500/30 flex items-center shadow-md">
        <div className="flex items-center gap-6 whitespace-nowrap animate-marquee text-xs font-medium uppercase tracking-wider">
          {newsItems.slice(0, 15).map((r, i) => (
            <span key={`ticker-1-${r.id || i}`} className="inline-flex items-center gap-2.5">
              <span className="h-2 w-2 rounded-full bg-orange-500 animate-pulse shrink-0 shadow-[0_0_8px_rgba(249,115,22,0.8)]" />
              <span className="font-black text-orange-400">[{r.type}]</span> 
        ...
        <div className="max-w-[1440px] mx-auto px-6 py-9 md:py-11 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2.5">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 px-3 py-1 text-[11px] font-black uppercase tracking-wider text-orange-600 dark:text-orange-400">
                <Zap size={13} className="animate-pulse text-orange-500" /> Real-Time Live Stream (30s Sync)
              </span>
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tight text-slate-900 dark:text-white uppercase">
              Live <span className="bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent">Updates</span>
            </h1>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-white/[0.08] dark:hover:bg-white/[0.14] text-slate-800 dark:text-white border border-slate-200/80 dark:border-white/10 hover:border-orange-500/40 hover:text-orange-500 px-4 py-2.5 text-xs font-bold shadow-2xs hover:shadow-xs active:scale-95 transition-all disabled:opacity-60 shrink-0 cursor-pointer"
            >
              <RefreshCw size={14} className={isSyncing ? "animate-spin text-orange-500" : "text-slate-500 dark:text-slate-300"} />
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 via-orange-600 to-amber-500 hover:opacity-95 active:scale-95 text-white px-4 py-2.5 text-xs font-black shadow-md shadow-orange-500/25 transition-all shrink-0 cursor-pointer"
            >
              <Plus size={15} />
          ...
          <div className="sticky top-20 space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-[#0c1322] p-5 shadow-sm">
              <h3 className="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-400 mb-4 flex items-center gap-2">
                <Filter size={14} className="text-orange-500 dark:text-orange-400" /> Jurisdictions
              </h3>
                  ...
                  return (
                    <button
                      ...
                      className={`text-left text-xs font-bold transition-all px-3.5 py-2.5 rounded-2xl flex items-center justify-between group cursor-pointer ${
                        isSelected
                          ? 'bg-orange-500/10 border border-orange-500/30 text-orange-600 dark:text-orange-400 font-black shadow-2xs'
            ...
            <div className="rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-[#0c1322] p-5 shadow-sm">
              <h3 className="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-400 mb-4 flex items-center gap-2">
                <Scale size={14} className="text-orange-500 dark:text-orange-400" /> Type
              </h3>
              <div className="flex flex-col gap-1.5">
          ...
          {loading ? (
            ...
            <div className="rounded-3xl border border-slate-200 bg-white dark:bg-[#0d1322] dark:border-white/10 p-12 text-center">
              ...
              <button 
                ...
                className="px-4 py-2 rounded-xl bg-orange-500 text-white text-xs font-bold hover:bg-orange-600 transition cursor-pointer"
              >
                Reset Filters
              </button>
            </div>
            ...
            <>
              ...
              {currentFeatured && (
                <div 
                  className="group relative overflow-hidden rounded-3xl border border-slate-200/90 dark:border-white/10 bg-white dark:bg-[#0d1322] shadow-sm hover:shadow-xl transition-all duration-300 hover:border-orange-500/40"
                ...
                >
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="w-full relative h-[280px] sm:h-[360px] md:h-[420px] overflow-hidden bg-slate-900">
                        ...
                        <div className="absolute top-4 left-4 flex items-center gap-2">
                          <span className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 text-white px-3.5 py-1 text-[11px] font-black uppercase tracking-wider shadow-md shadow-orange-500/30">
                      ...
                      <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-between">
                        <div>
                          ...
                          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black leading-[1.15] tracking-tight text-slate-900 dark:text-white group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors mb-4">
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-100 dark:border-white/5 flex flex-wrap items-center justify-between gap-3">
                          <div className="flex flex-wrap items-center gap-3 text-xs font-semibold text-slate-500 dark:text-slate-400">
                            <span className="flex items-center gap-1.5 font-bold text-slate-700 dark:text-slate-300">
                              <Clock size={13} className="text-orange-500 dark:text-orange-400" /> {currentFeatured.fullTimestamp || currentFeatured.date}
                            </span>
                            <span>•</span>
                            <a 
                              ...
                              className="inline-flex items-center gap-1 font-bold text-orange-600 dark:text-orange-400 hover:underline hover:opacity-80 transition-colors"
                  ...
                  <div className="bg-slate-100 dark:bg-slate-900/80 border-t border-slate-200/80 dark:border-white/5 px-6 py-3 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-3">
                      <span className="font-bold text-slate-600 dark:text-slate-300 flex items-center gap-1.5">
                        ...
                        Next headline in <span className="font-black text-orange-600 dark:text-orange-400 font-mono">{secondsRemaining}s</span>
                      </span>
                      <button 
                        onClick={(e) => { e.preventDefault(); setIsPaused(!isPaused); }}
                        className="p-1 rounded-md text-slate-400 hover:text-orange-500 transition cursor-pointer"
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button 
                        ...
                        className="p-1.5 rounded-lg bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-orange-500 border border-slate-200 dark:border-white/10 shadow-2xs transition cursor-pointer"
                  ...
                  <div className="w-full bg-slate-200 dark:bg-slate-800 h-1 overflow-hidden">
                    <div 
                      className="bg-gradient-to-r from-orange-500 to-amber-500 h-full transition-all duration-1000 ease-linear"
                  ...
                  {displayedListItems.map((item) => (
                    ...
                    >
                      <div>
                        ...
                        <h3 className="text-lg font-black leading-snug tracking-tight text-slate-900 dark:text-white group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors mb-2.5 line-clamp-2">
                          {item.title}
                        </h3>
                      ...
                      <div className="pt-3 border-t border-slate-100 dark:border-white/5 flex flex-col gap-2 text-xs">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="inline-flex items-center gap-1 font-black text-orange-600 dark:text-orange-400 group-hover:translate-x-1 transition-transform text-xs">
                        ...
                        <div className="flex items-center justify-between border-t border-dashed border-slate-100 dark:border-white/5 pt-1.5">
                          <a 
                            ...
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="inline-flex items-center gap-1 text-[11px] font-bold text-slate-500 dark:text-slate-400 hover:text-orange-500 dark:hover:text-orange-400 hover:underline transition-colors"
              ...
              {listItems.length > visibleCount && (
                <div className="flex justify-center pt-4">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-white dark:bg-[#0d1322] border border-slate-200 dark:border-white/10 text-xs font-bold text-slate-700 dark:text-slate-200 shadow-2xs hover:border-orange-500/40 hover:text-orange-500 dark:hover:text-orange-400 transition-all cursor-pointer"
                  >
          ...
          <div className="sticky top-20 space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-[#0c1322] p-5 shadow-sm">
              ...
              <div className="flex flex-col gap-3 text-xs font-bold">
                ...
                >
                  <span className="text-slate-700 dark:text-slate-200 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">Global (WIPO)</span>
                ...
                <button
                  ...
                  className="flex justify-between items-center p-2.5 rounded-xl hover:bg-slate-100/80 dark:hover:bg-white/5 border border-transparent hover:border-slate-200 dark:hover:border-white/10 transition-all text-left group cursor-pointer"
                >
                  <span className="text-slate-700 dark:text-slate-200 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">United States (USPTO)</span>
                ...
                <button
                  ...
                  className="flex justify-between items-center p-2.5 rounded-xl hover:bg-slate-100/80 dark:hover:bg-white/5 border border-transparent hover:border-slate-200 dark:hover:border-white/10 transition-all text-left group cursor-pointer"
                >
                  <span className="text-slate-700 dark:text-slate-200 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">European Union (EPO)</span>
                ...
                <button
                  ...
                  className="flex justify-between items-center p-2.5 rounded-xl hover:bg-slate-100/80 dark:hover:bg-white/5 border border-transparent hover:border-slate-200 dark:hover:border-white/10 transition-all text-left group cursor-pointer"
                >
                  <span className="text-slate-700 dark:text-slate-200 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">United Kingdom (UKIPO)</span>
                ...
                <button
                  ...
                  className="flex justify-between items-center p-2.5 rounded-xl hover:bg-slate-100/80 dark:hover:bg-white/5 border border-transparent hover:border-slate-200 dark:hover:border-white/10 transition-all text-left group cursor-pointer"
                >
                  <span className="text-slate-700 dark:text-slate-200 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">Asia-Pacific (APAC)</span>

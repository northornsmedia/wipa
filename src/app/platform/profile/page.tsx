    ...
    <div className="min-h-screen">
          ...
          <div className="bg-white dark:bg-[#0f172a] rounded-3xl border border-gray-200 dark:border-white/20 shadow-md overflow-hidden relative">
            ...
            >
              ...
              <button 
                ...
                className="absolute bottom-6 right-6 bg-white dark:bg-[#0f172a] px-6 py-3 rounded-2xl border border-gray-200 dark:border-white/20 font-bold text-sm flex items-center gap-2 hover:bg-[#5a32fa] hover:text-white transition-all shadow-sm hover:-translate-y-1 disabled:opacity-50"
              >
              ...
              <div className="flex-1 pt-4 md:pt-6 flex flex-col xl:flex-row justify-between items-start xl:items-end gap-6">
                ...
                <div className="flex gap-3 w-full xl:w-auto mt-4 xl:mt-0">
                  <button 
                    ...
                    className="flex-none bg-white dark:bg-[#0f172a] text-gray-900 dark:text-white p-2.5 rounded-xl font-bold border border-gray-200 dark:border-white/20 shadow-sm hover:bg-gray-50 dark:bg-white/5 transition-all flex items-center justify-center"
                  >
                    <Settings size={20} />
                  </button>
                  <button 
                    onClick={() => { setEditForm(profileData); setIsEditModalOpen(true); }} 
                    className="flex-1 xl:flex-none bg-white dark:bg-[#0f172a] text-gray-900 dark:text-white px-5 py-2.5 rounded-xl font-bold text-[15px] border border-gray-200 dark:border-white/20 shadow-sm hover:bg-gray-50 dark:bg-white/5 transition-all flex items-center justify-center gap-2"
                  >
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white dark:bg-[#0f172a] p-8 md:p-10 rounded-3xl border border-gray-200 dark:border-white/20 shadow-md relative overflow-hidden">
                ...
                <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-4">
                  About Me
                  <button className="text-gray-900 dark:text-white bg-gray-100 dark:bg-white/10 hover:bg-pink-50 border-2 border-transparent hover:border-gray-200 dark:border-white/20 p-2 rounded-xl transition-all shadow-none hover:shadow-[2px_2px_0px_0px_#131313]"><Edit3 size={20} /></button>
                </h3>
              ...
              <div className="bg-white dark:bg-[#0f172a] p-8 md:p-10 rounded-3xl border border-gray-200 dark:border-white/20 shadow-md">
                <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 flex items-center justify-between">
                  Experience
                  <button className="text-gray-900 dark:text-white bg-gray-100 dark:bg-white/10 hover:bg-green-50 border-2 border-transparent hover:border-gray-200 dark:border-white/20 p-3 rounded-xl transition-all font-bold text-sm flex items-center gap-2 hover:shadow-sm">
                ...
                <div className="space-y-10 relative before:absolute before:inset-0 before:ml-[28px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-1 before:bg-gray-200">
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    ...
                    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-2xl border border-gray-200 dark:border-white/20 bg-white dark:bg-[#0f172a] shadow-sm hover:-translate-y-1 transition-transform">
                      <h4 className="text-xl font-bold text-gray-900 dark:text-white">{profileData.role || 'Professional Role'}</h4>
                      <p className="text-base font-bold text-[#5a32fa] mb-2">{profileData.company || 'Company Name'}</p>
                      {profileData.experienceYears ? (
                        <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mb-4 bg-gray-100 dark:bg-white/10 inline-block px-3 py-1 rounded-lg">{profileData.experienceYears} Years Experience</p>
                      ) : null}
                      {profileData.education && (
                        <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mb-4 bg-gray-100 dark:bg-white/10 inline-block px-3 py-1 rounded-lg ml-2">{profileData.education}</p>
                      )}
              ...
              <div className="bg-white dark:bg-[#0f172a] p-8 md:p-10 rounded-3xl border border-gray-200 dark:border-white/20 shadow-md mt-8">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center justify-between">
                  Certifications & Awards
                  <button className="text-gray-900 dark:text-white bg-gray-100 dark:bg-white/10 hover:bg-green-50 border-2 border-transparent hover:border-gray-200 dark:border-white/20 p-2 rounded-xl transition-all font-bold text-sm flex items-center gap-2 hover:shadow-sm">
                    <span className="text-lg leading-none">+</span> Add
                  </button>
                </h3>
                <div className="space-y-4">
                  <div className="flex gap-4 p-5 rounded-2xl border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/5 hover:bg-white dark:bg-[#0f172a] hover:border-gray-200 dark:border-white/20 hover:shadow-sm transition-all group">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white group-hover:text-[#5a32fa] transition-colors">Certified Information Privacy Professional (CIPP/E)</h4>
                      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">IAPP - International Association of Privacy Professionals</p>
                  ...
                  <div className="flex gap-4 p-5 rounded-2xl border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/5 hover:bg-white dark:bg-[#0f172a] hover:border-gray-200 dark:border-white/20 hover:shadow-sm transition-all group">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white group-hover:text-[#00d26a] transition-colors">Top 40 Under 40 - Tech Lawyers</h4>
                      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Legal Innovation Weekly</p>
              ...
              <div className="bg-white dark:bg-[#0f172a] p-8 md:p-10 rounded-3xl border border-gray-200 dark:border-white/20 shadow-md mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-5 rounded-2xl border border-gray-200 dark:border-white/20 hover:border-[#5a32fa] hover:shadow-md transition-all cursor-pointer bg-white dark:bg-[#0f172a] group">
                    <div className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-white/10 flex items-center justify-center mb-4 group-hover:bg-[#5a32fa]/10 transition-colors">
                      <Folder size={20} className="text-gray-600 dark:text-gray-300 group-hover:text-[#5a32fa]" />
                    </div>
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2 group-hover:text-[#5a32fa] transition-colors">AI Copyright Framework</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-2">Led a cross-functional team to develop internal guidelines for generative AI tools usage and IP liability.</p>
                  </div>
                  <div className="p-5 rounded-2xl border border-gray-200 dark:border-white/20 hover:border-[#5a32fa] hover:shadow-md transition-all cursor-pointer bg-white dark:bg-[#0f172a] group">
                    <div className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-white/10 flex items-center justify-center mb-4 group-hover:bg-[#5a32fa]/10 transition-colors">
                      <Folder size={20} className="text-gray-600 dark:text-gray-300 group-hover:text-[#5a32fa]" />
                    </div>
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2 group-hover:text-[#5a32fa] transition-colors">Open Source Policy</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-2">Drafted and implemented the company-wide open source contribution and consumption policy.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <aside className="w-[300px] hidden xl:flex flex-col shrink-0 space-y-6 pt-6 sticky top-[73px] h-[calc(100vh-73px)] overflow-y-auto no-scrollbar pb-10">
            ...
            <div className="shrink-0 bg-[#0a0a0a] rounded-3xl border border-gray-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-6 pb-8 text-white relative overflow-hidden">
              ...
              <div className="space-y-3 relative z-10">
                ...
                <button 
                  className="w-full bg-white dark:bg-[#0f172a]/5 border border-white/10 hover:bg-white dark:bg-[#0f172a]/10 text-white px-4 py-3 rounded-[14px] font-bold text-sm flex items-center justify-center gap-2 transition-all"
                >
            ...
            <div className="shrink-0 bg-white dark:bg-[#0f172a] rounded-3xl border border-gray-200 dark:border-white/20 shadow-sm p-6">
              <h3 className="font-bold text-gray-900 dark:text-white mb-4 text-sm">People Also Viewed</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 group cursor-pointer">
                    ...
                    <div className="overflow-hidden">
                      <h4 className="font-bold text-sm text-gray-900 dark:text-white truncate group-hover:text-[#5a32fa] transition-colors">{person.name}</h4>
                      <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{person.role}</p>
                    </div>
                  </div>
                ))}
              </div>
              <button className="w-full mt-4 py-2 text-sm font-bold text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-white border border-gray-200 dark:border-white/20 rounded-xl hover:bg-gray-50 dark:bg-white/5 transition-colors">
                View all recommendations
              </button>
            </div>

            <div className="bg-white dark:bg-[#0f172a] rounded-3xl border border-gray-200 dark:border-white/20 shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900 dark:text-white"><span className="font-bold">You</span> liked a post by Sarah Jenkins</p>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900 dark:text-white"><span className="font-bold">You</span> commented on "AI in Patents"</p>
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#5a32fa]/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-[#0f172a] w-full max-w-lg rounded-2xl border border-gray-200 dark:border-white/20 shadow-md flex flex-col max-h-[90vh]">
            <div className="flex justify-between items-center p-6 border-b-4 border-gray-200 dark:border-white/20">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Profile</h2>
              <button 
                onClick={() => setIsEditModalOpen(false)}
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 border-2 border-transparent hover:border-gray-200 dark:border-white/20 hover:bg-gray-200 transition-all"
              >
            ...
            <div className="p-6 overflow-y-auto space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-white/20 focus:outline-none focus:border-[#5a32fa] font-medium"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Headline / Role</label>
                <input 
                  type="text"
                  value={editForm.role}
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Location</label>
                <input 
                  type="text"
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Profile Photo</label>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-2xl bg-gray-100 dark:bg-white/10 border-2 border-gray-200 dark:border-white/20 flex items-center justify-center overflow-hidden">
                    {editForm.avatarUrl ? (
                  ...
                  <button onClick={() => avatarInputRef.current?.click()} className="px-4 py-2 bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-white/10 rounded-xl font-bold text-sm shadow-[2px_2px_0px_0px_#131313] hover:-translate-y-0.5 transition-all">
                    Upload Photo
                  </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Company</label>
                  <input 
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Years of Experience</label>
                  <input 
                    type="number"
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Education</label>
                <input 
                  type="text"
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Skills (comma separated)</label>
                <input 
                  type="text"
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-white/20 focus:outline-none focus:border-[#5a32fa] font-medium min-h-[100px]"
                />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">LinkedIn URL</label>
                  <input 
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Website URL</label>
                  <input 
                    type="text"
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Practice Areas (comma separated)</label>
                <input 
                  type="text"
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Bio / About</label>
                <textarea 
                  rows={4}
                  value={editForm.bio}
                  onChange={(e) => setEditForm({...editForm, bio: e.target.value})}
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-white/20 focus:outline-none focus:border-[#5a32fa] font-medium resize-none"
                />
              </div>
            </div>
            
            <div className="p-6 border-t-4 border-gray-200 dark:border-white/20 flex gap-4">
              <button 
                onClick={() => setIsEditModalOpen(false)}
                className="flex-1 py-3 bg-white dark:bg-[#0f172a] text-gray-900 dark:text-white rounded-xl font-bold border border-gray-200 dark:border-white/20 hover:bg-gray-50 dark:bg-white/5 transition-colors shadow-sm active:translate-y-1 active:shadow-none"
              >
                Cancel
              </button>
              <button 
                ...
                disabled={isSaving}
                className="flex-1 py-3 bg-green-50 text-gray-900 dark:text-white rounded-xl font-bold border border-gray-200 dark:border-white/20 hover:bg-[#00e373] transition-colors shadow-sm active:translate-y-1 active:shadow-none flex items-center justify-center gap-2 disabled:opacity-50"
              >
      ...
      {isSettingsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#5a32fa]/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-[#0f172a] w-full max-w-md rounded-2xl border border-gray-200 dark:border-white/20 shadow-md flex flex-col">
            <div className="flex justify-between items-center p-6 border-b-4 border-gray-200 dark:border-white/20">
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Current Password</label>
                    <input 
                      type="password"
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">New Password</label>
                    <input 
                      type="password"
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-gradient-to-br from-white via-white to-[#f0ebff] rounded-[2rem] w-full max-w-sm overflow-hidden flex flex-col relative shadow-[0_0_50px_rgba(90,50,250,0.25)] animate-in fade-in zoom-in duration-300 border border-white/50">
            ...
            <div className="p-6 pb-2 relative flex justify-between items-center z-10">
              <div>
                <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Share Profile</h2>
                <p className="text-sm font-bold text-[#5a32fa]">Digital Business Card</p>
              </div>
              <button onClick={() => setIsShareModalOpen(false)} className="bg-white dark:bg-[#0f172a]/80 backdrop-blur-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-white hover:bg-gray-100 dark:bg-white/10 transition-colors p-2.5 rounded-full shadow-sm border border-gray-100 dark:border-white/10">
                <X size={20} />
              </button>
            </div>
            
            <div className="px-8 pb-8 pt-4 flex flex-col items-center relative z-10">
              <p className="text-[14px] text-gray-600 dark:text-gray-300 font-medium text-center mb-8 max-w-[250px] leading-relaxed">
              ...
              <div className="relative mb-10 group">
                ...
                <div className="bg-white dark:bg-[#0f172a] p-4 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.08)] relative ring-1 ring-gray-100/50 transform group-hover:-translate-y-1 transition-all duration-300">
                  <QRCodeCanvas 
                    id="qr-code-canvas"
              ...
              <div className="w-full">
                <div className="flex items-center gap-2 bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-white/20/80 p-1.5 rounded-2xl shadow-sm">
                  <input 
                    type="text" 
                    readOnly 
                    value={`${window.location.origin}/u/${profileData.memberId}`}
                    className="flex-1 bg-transparent border-none focus:outline-none text-gray-500 dark:text-gray-400 text-[13px] px-3 font-semibold truncate"
                  />
                  <button 
                    onClick={() => {
                    ...
                    className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 dark:border-white/20 p-2.5 rounded-xl text-gray-700 dark:text-gray-200 hover:from-[#5a32fa] hover:to-[#8c65ff] hover:text-white hover:border-[#5a32fa] transition-all shadow-sm flex items-center gap-2 font-bold text-sm group"
                  >
      ...
      {isFeatureModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-[#0f172a] w-full max-w-md rounded-[24px] shadow-2xl p-8 relative">
            <button 
              onClick={() => setIsFeatureModalOpen(false)}
              className="absolute top-6 right-6 w-8 h-8 bg-gray-100 dark:bg-white/10 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-200 transition-colors"
            >
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Request a Feature</h3>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-6">Have an idea to make WIPA better? We're all ears!</p>
            
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Select a Feature Idea</label>
                <div className="flex flex-wrap gap-2 max-h-[160px] overflow-y-auto p-3 bg-gray-50 dark:bg-white/5 border-2 border-gray-100 dark:border-white/10 rounded-xl custom-scrollbar">
                  {[
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-sm font-bold border transition-all ${
                        featureForm.title === feat 
                          ...
                          : 'bg-white dark:bg-[#0f172a] text-gray-600 dark:text-gray-300 border-gray-200 dark:border-white/20 hover:border-[#5a32fa]/40 hover:bg-white dark:bg-[#0f172a]'
                      }`}
                    >
                      {feat}
                    </button>
              ...
              {featureForm.title === 'Other' && (
                <div>
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Your Idea</label>
                  <input 
                    type="text"
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-white/20 focus:border-[#5a32fa] focus:outline-none font-medium"
                  />
                </div>
              )}
              
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Details (Optional)</label>
                <textarea 
                  value={featureForm.description}
                  onChange={(e) => setFeatureForm({...featureForm, description: e.target.value})}
                  placeholder="Tell us how this would help you..."
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-white/20 focus:border-[#5a32fa] focus:outline-none font-medium min-h-[90px]"
                />
              </div>
              <button 
                onClick={() => {
      ...
      {isSupportModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-[#0f172a] w-full max-w-md rounded-[24px] shadow-2xl p-8 relative border-t-[10px] border-[#131313]">
            <button 
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-6">Need help with your account? Send us a message.</p>
            
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Select an Issue</label>
                <div className="flex flex-wrap gap-2 max-h-[160px] overflow-y-auto p-3 bg-gray-50 dark:bg-white/5 border-2 border-gray-100 dark:border-white/10 rounded-xl custom-scrollbar">
                  {[
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-sm font-bold border transition-all ${
                        supportForm.subject === issue 
                          ...
                          : 'bg-white dark:bg-[#0f172a] text-gray-600 dark:text-gray-300 border-gray-200 dark:border-white/20 hover:border-black dark:border-white/20/40 hover:bg-white dark:bg-[#0f172a]'
                      }`}
                    >
                      {issue}
                    </button>
              ...
              {supportForm.subject === 'Other' && (
                <div>
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Issue Topic</label>
                  <input 
                    type="text"
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-white/20 focus:border-[#131313] focus:outline-none font-medium"
                  />
                </div>
              )}
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-white/20 focus:border-[#131313] focus:outline-none font-medium min-h-[100px]"
                />
              </div>
              <button 
                onClick={() => {

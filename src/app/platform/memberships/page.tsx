...
export default function MembershipsPage() {
  ...
  if (isLoading) {
    return <div className="min-h-screen flex items-center justify-center"><p className="font-bold text-gray-500 dark:text-gray-400">Loading Memberships...</p></div>;
  }
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] dark:bg-[#0f172a]"><div className="py-12 px-4 md:px-8 max-w-6xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl font-bold text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className={`bg-white dark:bg-[#0f172a] rounded-[2rem] border-2 ${currentTier === 'student' ? 'border-[#5a32fa] shadow-md ring-4 ring-[#5a32fa]/10' : 'border-gray-100 dark:border-white/10 shadow-sm hover:shadow-md'} p-8 flex flex-col relative overflow-hidden transition-all`}>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mt-4">For students and recent graduates pursuing careers in IP.</p>
          </div>
          
          <div className="flex-1 space-y-4 mb-8">
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Access to Jobs Board</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Mentorship Opportunities</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Basic Networking</span>
            </div>
          </div>
        ...
        {/* STARTUPS PLAN */}
        <div className={`bg-white dark:bg-[#0f172a] rounded-[2rem] border-2 ${currentTier === 'startup' ? 'border-[#ffc900] shadow-md ring-4 ring-[#ffc900]/10' : 'border-gray-100 dark:border-white/10 shadow-sm hover:shadow-md'} p-8 flex flex-col relative overflow-hidden transition-all md:-translate-y-4`}>
          {currentTier === 'startup' && (
            <div className="absolute top-0 right-0 bg-[#ffc900] text-gray-900 dark:text-white text-xs font-bold px-4 py-2 rounded-bl-xl border-b border-l border-[#ffc900]">
              CURRENT PLAN
            </div>
          )}
          <div className="mb-8">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-5xl font-bold text-gray-900 dark:text-white">£295</span>
              <span className="text-lg font-bold text-gray-500 dark:text-gray-400">/year</span>
            </div>
            <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mt-4">For founders, innovators, and emerging IP businesses.</p>
          </div>
          
          <div className="flex-1 space-y-4 mb-8">
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Company Page Listing</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Direct Messaging</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Access to Resource Library</span>
            </div>
          </div>
        ...
        <div className={`bg-white dark:bg-[#0f172a] rounded-[2rem] border-2 ${currentTier === 'ip_professional' ? 'border-[#00d26a] shadow-md ring-4 ring-[#00d26a]/10' : 'border-gray-100 dark:border-white/10 shadow-sm hover:shadow-md'} p-8 flex flex-col relative overflow-hidden transition-all`}>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-5xl font-bold text-gray-900 dark:text-white">£395</span>
              <span className="text-lg font-bold text-gray-500 dark:text-gray-400">/year</span>
            </div>
            <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mt-4">For IP lawyers, attorneys, and patent professionals.</p>
          </div>
          
          <div className="flex-1 space-y-4 mb-8">
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Verified Professional Badge</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Global Directory Listing</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Unlimited Platform Access</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="text-[#00d26a] mt-0.5 flex-shrink-0" size={20} strokeWidth={3} />
              <span className="font-bold text-gray-700 dark:text-gray-200">Advanced Analytics</span>
            </div>
          </div>
      ...
      <div className="mt-16 w-full rounded-[2.5rem] bg-[#0f172a] p-[2px] relative group overflow-hidden shadow-[0_20px_60px_-15px_rgba(90,50,250,0.3)] hover:shadow-[0_20px_80px_-10px_rgba(255,144,232,0.4)] transition-all duration-700">
        ...
        <div className="relative bg-[#0f172a] rounded-[2.4rem] h-full w-full p-10 md:p-14 overflow-hidden flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1 relative z-10 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-[#0f172a]/10 border border-white/20 text-white text-xs font-black uppercase tracking-widest mb-6 backdrop-blur-md shadow-lg">
            ...
            <button className="relative overflow-hidden bg-white dark:bg-[#0f172a] text-[#131313] px-8 py-4 rounded-2xl font-black text-lg group/btn hover:scale-105 transition-transform duration-300 shadow-[0_0_40px_rgba(255,255,255,0.3)]">
          ...
          <div className="w-full md:w-[400px] relative z-10 hidden md:block">
            <div className="w-full aspect-square relative group-hover:rotate-3 group-hover:scale-105 transition-transform duration-700 ease-out">
              ...
              <div className="relative w-full h-full bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-3xl border border-white/10 overflow-hidden shadow-2xl flex flex-col items-center justify-center p-8 backdrop-blur-sm">
                ...
                {/* Floating Elements */}
                <div className="absolute top-8 left-8 w-12 h-12 bg-white dark:bg-[#0f172a]/5 rounded-xl border border-white/10 flex items-center justify-center backdrop-blur-md shadow-lg transform -rotate-12 group-hover:rotate-12 transition-transform duration-700">
                  <span className="text-[#ff90e8] font-black text-xl">AI</span>
                </div>
                <div className="absolute bottom-8 right-8 w-14 h-14 bg-white dark:bg-[#0f172a]/5 rounded-full border border-white/10 flex items-center justify-center backdrop-blur-md shadow-lg transform rotate-12 group-hover:-rotate-12 transition-transform duration-700">

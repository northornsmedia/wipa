...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060608] dark:bg-[#060608] light:bg-[#f8f9fa] text-white flex flex-col justify-between items-center p-6 relative overflow-hidden font-sans selection:bg-pink-500 selection:text-white">
      ...
      <header className="w-full max-w-sm flex items-center justify-between z-10 pt-2 pb-4">
        {/* Official WIPA Brand Logo replacing mock logo */}

...
export interface AnimatedGradientBackgroundProps {
   ...
   * @default ["#5a32fa", "#7c3aed", "#ff90e8", "#ff6d00", "#ffc900", "#00d26a", "#0a0a0f"]
   */
 ...
 *
 * Renders a customizable animated radial gradient background with dynamic breathing physics.
 */
export const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
  ...
  gradientStops = [20, 35, 50, 65, 80, 92, 100],
  animationSpeed = 0.04,
  breathingRange = 8,
  containerStyle = {},
  topOffset = 0,

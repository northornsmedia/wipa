  ...
  (
    {
      ...
      className,
      models = ["LexIQ Fast", "LexIQ Advanced"],
    ...
    const startRecording = useCallback(async () => {
      ...
      try {
        if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
          ...
          handleValueChange("Microphone access is not available in this environment.");
          setIsRecording(false);
          setExpanded(false);
          return;
        }
        ...
        handleValueChange("Microphone access denied. Please allow microphone permissions.");
        setIsRecording(false);
        setExpanded(false);
        return;
      }
      ...
      if (stream) {
        ...
        if (SpeechRecognition) {
          ...
          handleValueChange("Voice dictation is not supported in this browser. Please type your message.");
          setTimeout(() => stopRecording(), 3000);
        }
      }
    }, [handleValueChange, stopRecording, disabled]);
    ...
    return (
      <>
        ...
        <div
          ...
          onBlur={handleBlur}
          className={cn("relative flex flex-col w-full mx-auto", className, disabled && "opacity-70 pointer-events-none")}
          style={{
        ...
        >
          ...
          >
            <div
              ...
              className="border border-border/20 dark:border-white/10 border-b-0 bg-white dark:bg-[#1e293b] rounded-t-2xl px-2 pt-2 pb-1 flex items-start gap-2 overflow-x-auto prompt-scrollbar shadow-lg"
            >
          ...
          <div
            ...
            className={cn(
              "relative w-full border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1e293b] shadow-xl focus-within:border-[#5a32fa]/40 focus-within:ring-1 focus-within:ring-[#5a32fa]/20 hover:border-gray-300 dark:hover:border-white/20 z-10",
          ...
          >
            ...
            <textarea
              ...
              className={cn(
                "prompt-scrollbar absolute top-0 inset-x-0 z-[1] w-full resize-none bg-transparent pl-4 pr-12 py-3.5 text-sm leading-[22px] text-gray-900 dark:text-white outline-none placeholder:font-medium placeholder:text-gray-500 cursor-text",
            ...
            <div
              ref={topFadeRef}
              className="absolute left-4 right-12 top-0 z-[2] h-8 bg-gradient-to-b from-white dark:from-[#1e293b] via-white/90 dark:via-[#1e293b]/90 to-transparent pointer-events-none"
            />
            <div
              ref={bottomFadeRef}
              className="absolute left-4 right-12 z-[2] h-8 bg-gradient-to-t from-white dark:from-[#1e293b] via-white/90 dark:via-[#1e293b]/90 to-transparent pointer-events-none"
              style={{ 
                opacity: 0, 
            ...
            <button
              ...
              className={cn(
                "absolute inset-x-0 top-0 z-[1] cursor-text pl-4 pr-12 py-[15px] text-left text-sm font-medium leading-[17px] text-gray-500 outline-none truncate block",
            ...
            >
              ...
              <button
                ...
                className="group flex items-center gap-1 rounded-full px-2 py-1 text-gray-400 dark:text-gray-500 transition-all duration-200 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white outline-none cursor-default"
              >
              ...
              <button
                ...
                className="ml-auto flex size-7 items-center justify-center rounded-full text-gray-400 dark:text-gray-500 transition-all duration-200 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white outline-none cursor-default disabled:opacity-40 disabled:pointer-events-none"
              >
                <PlusIcon />
              </button>
            </div>
            ...
            >
              {audioData.map((val, i) => (
                <div
                  key={i}
                  className="w-1 rounded-full bg-[#5a32fa] transition-[height] duration-75 ease-out"
            ...
            <button
              ...
              className="absolute right-2 bottom-2 z-[10] flex h-8 w-8 items-center justify-center bg-[#5a32fa] text-white transition-all duration-300 hover:opacity-90 outline-none focus-visible:ring-2 focus-visible:ring-[#5a32fa]/50 cursor-default"
            >

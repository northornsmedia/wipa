    ...
    <div className={cn("w-full mx-auto pt-0 pb-12 px-4 sm:px-6 space-y-12", className)}>
      ...
      <div className="w-full flex flex-col items-center">
        <motion.div
          ...
          className="group relative cursor-pointer overflow-hidden rounded-[32px] shadow-2xl w-full max-w-sm sm:max-w-md h-[490px] min-h-[490px] border-2 border-amber-400/40 hover:border-amber-400/80 transition-colors hover:shadow-amber-500/10"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl mx-auto">
          {REGIONAL_CHAIRS.map((item) => (
            <motion.div
              ...
              className="group relative cursor-pointer overflow-hidden rounded-[32px] shadow-xl w-full h-[470px] min-h-[470px] border border-gray-200/80 dark:border-white/10 hover:border-pink-500/50 transition-colors hover:shadow-pink-500/5"
          ...
          <>
            ...
            <div className="fixed inset-0 flex items-center justify-center z-[9999] p-4 md:p-10 pointer-events-none mt-10 md:mt-0">
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 320, damping: 30 }}
                className="w-full max-w-4xl h-[70vh] min-h-[450px] max-h-[600px] bg-white dark:bg-[#0f172a] rounded-[32px] overflow-hidden flex flex-col shadow-2xl pointer-events-auto relative border border-gray-100 dark:border-white/10"
              >
                <button
                  onClick={() => setActiveItem(null)}

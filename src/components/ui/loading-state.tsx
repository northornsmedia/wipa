...
export default function LoadingState({
  ...
  return (
    <>
      ...
      `}} />
      <div className="flex w-fit items-center gap-2.5 text-gray-900">
        ...
        <span
          ...
          style={{
            backgroundImage:
              "linear-gradient(90deg, rgba(17,24,39,0.5) 35%, rgba(17,24,39,1) 50%, rgba(17,24,39,0.5) 65%)",
        ...
        <span className="font-mono text-[12px] text-gray-900/60 tabular-nums">
          {elapsed}
        </span>
      </div>
    </>

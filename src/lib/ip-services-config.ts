...
export const DEFAULT_GENIE_CONFIG: IPServiceConfig = {
  ...
  offer: {
    ...
    title: "25% off Genie Pro for your first 12 months",
    description: "As a Women's IP Alliance member, you get full access to Genie's drafting and negotiation tools — essential for licensing agreements, assignment agreements and NDAs — at 25% off for your first 12 months.",
    discount: "25% Off for 12 Months",
    promoCode: "WIPA25",
    ctaText: "Claim Your 25% Discount",
    ctaUrl: "https://www.genieai.co/partners/wipa",
    contactEmail: "partnerships@genieai.co",
    terms: "Offer details: 25% off Genie Pro for 12 months when your customers use code WIPA25 at checkout.",
    steps: [
      "Visit the partner landing page: genieai.co/partners/wipa",
      "Sign up for an account with your business email.",
      "Enter promo code WIPA25 at checkout.",
      "Enjoy 25% off Genie Pro for your first 12 months!"
    ]
  },
  versions: {
    v1: {
